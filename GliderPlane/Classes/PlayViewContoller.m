...
@implementation PlayViewContoller
@synthesize quit1, lblscore, lblhigh;
@synthesize glider, cloud1, cloud2, cloud3, cloud4, cloud5;
@synthesize highScore, selectedGlider, sensitivity1;
...
-(void) reset{
    ...
    cloud4.center = CGPointMake(-200,-200);
    cloud5.center = CGPointMake(-500, -500);
